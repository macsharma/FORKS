...
import os
print (os.getcwd())
path1="D:\Dropbox\phd\pseudotemporal\deng_2014_python"
os.chdir(path1)
print (os.getcwd())
#%%
...
dataframe=pd.read_csv("data/deng2014Data.txt",sep="\t")
...
#%% select cells from 0 to 293
data=data[0:294,:]
cell_names=cell_names[0:294]
actual_time=actual_time[0:294]
#%%
...
#all_mapping_type=['Isomap','MDS','PCA','RandomForest','tSNE']
